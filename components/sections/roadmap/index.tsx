              ...
              <div className="relative overflow-hidden rounded-[2.4375rem] bg-n-8 p-8 xl:p-15">
                ...
                <div className="relative z-1">
                  ...
                  <div className="-mx-15 -my-10 mb-10">
                    ...
                    />
                    {item.id === "0" && (
                      <div className="absolute top-1/2 right-4 -translate-y-1/2 rounded bg-n-1/10 px-4 py-2 text-xs font-bold uppercase tracking-widest text-n-1 backdrop-blur-md border border-n-1/20">
                        Access Verified
                      </div>
                    )}
                  </div>
